  ...
  return (
    <div className="grid gap-8">
      <PageHeader
        ...
        description="Visão operacional dos atletas da entrada à recorrência, com atenção especial à segunda participação e ao risco de inatividade."
      />
      ...
      <CommandSection
        title={`${snapshot.filteredRows.length} atleta(s)`}
        description="A fonte de verdade é o cadastro oficial; engajamento complementa o perfil quando existe histórico de comportamento."
      >
