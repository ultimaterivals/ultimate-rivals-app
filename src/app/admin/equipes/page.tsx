  ...
  return (
    <div className="grid gap-8">
      <PageHeader
        ...
        description="Visão institucional das equipes, seus atletas e a ocupação das até 5 duplas permitidas por categoria e temporada."
      />
      ...
      <Card className="border-ur-gold/30">
        <p className="font-bold">Regra estrutural já protegida no banco</p>
      ...
      {snapshot.teams.length === 0 ? (
        <Card>
          ...
          <p className="mt-2 text-sm text-zinc-500">
            Quando os dados forem migrados, as equipes aparecerão aqui com a
