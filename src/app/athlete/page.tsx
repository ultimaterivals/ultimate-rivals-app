    ...
    <div className="grid gap-9">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <Card>
          ...
          <p className="mt-2 text-sm text-zinc-500">
            unidades disponíveis em pacotes ativos
          </p>
        </Card>
        <Card>
          <div className="flex items-center justify-between gap-3">
      ...
      <section className="grid gap-4">
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-500">
              Sua próxima ação dentro do ecossistema.
            </p>
          </div>
          <Link
            href="/athlete/agenda"
            className="text-ur-gold flex items-center gap-1 text-sm font-bold"
          >
        ...
        {snapshot.nextReservation ? (
          ...
          <Card>
            <p className="font-bold">
              Você ainda não possui uma reserva futura.
            </p>
            <p className="mt-2 text-sm text-zinc-400">
              Acesse a agenda para encontrar oportunidades disponíveis para sua
              jornada.
            </p>
          </Card>
        )}
      ...
      <section className="grid gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-500">
            Histórico esportivo consolidado no sistema.
          </p>
        </div>
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          <Card>
            <p className="text-xs text-zinc-500 uppercase">Competições</p>
            <p className="font-display mt-2 text-2xl font-black">
              {summary?.competitions ?? "—"}
            </p>
          </Card>
          <Card>
            <p className="text-xs text-zinc-500 uppercase">Treinos</p>
            <p className="font-display mt-2 text-2xl font-black">
              {summary?.trainingAttendance ?? "—"}
            </p>
          </Card>
          <Card>
            <p className="text-xs text-zinc-500 uppercase">Hunter concluído</p>
            <p className="font-display mt-2 text-2xl font-black">
      ...
      {nextOpportunities.length > 0 && (
        <section className="grid gap-4">
          <div className="flex items-center justify-between gap-4">
            ...
            <Link
              href="/athlete/agenda"
              className="text-ur-gold text-sm font-bold"
            >
              Ver todas
            </Link>
          </div>
