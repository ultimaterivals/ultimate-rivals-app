  ...
  const { sessionId } = await params,
    ...
    { data: queueEntry } = athlete
      ? await c
          ...
          .select(
            "status,queued_at,current_match_id,matches(match_code,status,courts(name),match_sides!match_sides_match_id_fkey(side,match_participants(athlete_id,athletes(public_name)),match_squad_members(athlete_id,initial_squad_role,squad_role,status,reserve_presence_status)))",
          )
