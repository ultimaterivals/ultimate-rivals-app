...
vi.mock("@/server/repositories/admin-athletes-repository", () => ({ fetchAdminAthletesRepositoryData: vi.fn() }));
...
describe("admin athletes service", () => {
  ...
  it("keeps athletes without engagement history in the official base", async () => {
    repositoryMock.mockResolvedValue({ athletes: [{ id: "a1", public_name: "Nova", athlete_code: "UR1", status: "active", primary_pole_id: null }], engagement: [], reports: [], memberships: [], teams: [], poles: [], errors: [] });
  ...
  it("segments first-only and free-agent athletes", async () => {
    repositoryMock.mockResolvedValue({ athletes: [{ id: "a1", public_name: "Atleta", athlete_code: "UR1", status: "active", primary_pole_id: null }], engagement: [{ athlete_id: "a1", source: "instagram", first_participation_at: "2026-08-01T00:00:00Z", second_participation_at: null, last_participation_at: "2026-08-01T00:00:00Z", participations_30d: 1, active_30d: true, returning_athlete: false, days_since_last_participation: 9 }], reports: [], memberships: [], teams: [], poles: [], errors: [] });
