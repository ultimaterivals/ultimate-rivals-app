-- Preserve the atomic redemption contract; an admin must still have their own athlete identity.
...
begin
  if private.current_app_role() not in ('athlete'::public.app_role, 'admin'::public.app_role) then
