...
values
  ('a0000000-0000-4000-8000-000000000003','pole_manager','pole','20000000-0000-4000-8000-000000000001',null,'2026-01-01 00:00:00+00','active','a0000000-0000-4000-8000-000000000001'),
  ('a0000000-0000-4000-8000-000000000004','team_manager','team',null,'c0000000-0000-4000-8000-000000000001','2026-01-01 00:00:00+00','active','a0000000-0000-4000-8000-000000000001')
...
values
  ('b0000000-0000-4000-8000-000000000001','c0000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000001','athlete','2026-01-01 00:00:00+00','active','a0000000-0000-4000-8000-000000000001'),
  ('b0000000-0000-4000-8000-000000000002','c0000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000001','athlete','2026-01-01 00:00:00+00','active','a0000000-0000-4000-8000-000000000001'),
  ('b0000000-0000-4000-8000-000000000003','c0000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000001','athlete','2026-01-01 00:00:00+00','active','a0000000-0000-4000-8000-000000000001')
on conflict do nothing;
...
values
  ('b0000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000001','n2','active','2026-01-01 00:00:00+00','a0000000-0000-4000-8000-000000000001','[QA] baseline level'),
  ('b0000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000001','n2','active','2026-01-01 00:00:00+00','a0000000-0000-4000-8000-000000000001','[QA] baseline level'),
...
with cycle as (
  ...
  limit 1
), participation_rule as (
  select id, version from public.ranking_rules
  where rule_code = 'PARTICIPATION' and event_context = 'ur_play' and active
...
select
  ...
  tx.source_id::uuid,
  participation_rule.id,
  'PARTICIPATION',
  participation_rule.version,
  tx.points,
  tx.points,
